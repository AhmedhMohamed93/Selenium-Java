...
public class TestBase 
{
     ...
     ****************************************************************************************************/	
      ...
      *   Inputs      : Webdriver instance    															 *
      *   				String screenshot name															 *
      *   				String Folder name                                                               *
      *   Outputs     : void                                                                             *
      *   Description : This Method is to capture screenshots at the end of each test case               *
      *                                                                                                  *
	  * @throws Throwable 																			     *
      ****************************************************************************************************/	 
	 
		public void captureScreenshot(WebDriver driver , String screenshotName, String Foldername) throws Throwable
		{
			try
			{
				...
				FileUtils.copyFile(source , new File("./Screenshots/"+Foldername+"/"+ screenshotName+".jpg"),true);
				System.out.println("Screenshot is taken");
				
			}catch(Exception e)
			{
				System.out.println("Error while taking Screenshot is : " + e.getMessage());
			}
		}
